...
using MedicMod.Modules.Characters;
using RoR2;
using RoR2.Skills;
using System;
...
{
    internal class Medic : SurvivorBase
    {
        ...
        public const string MEDIC_PREFIX = MedicPlugin.DEVELOPER_PREFIX + "_MEDIC_BODY_";

        //used when registering your survivor's language tokens
        public override string survivorTokenPrefix => MEDIC_PREFIX;

        public override BodyInfo bodyInfo { get; set; } = new BodyInfo
        {
            bodyName = "HenryBody",
            bodyNameToken = MEDIC_PREFIX + "NAME",
            subtitleNameToken = MEDIC_PREFIX + "SUBTITLE",
        ...
        public override void InitializeSkills()
        {
            ...
            string prefix = MedicPlugin.DEVELOPER_PREFIX;
            ...
            Modules.Skills.AddSecondarySkills(bodyPrefab, injectSkillDef);
            #endregion
            ...
            healSkillDef = Modules.Skills.CreateSkillDef(new SkillDefInfo
            {
                ...
                skillDescriptionToken = prefix + "_MEDIC_BODY_SPECIAL_HEAL_DESCRIPTION",
                skillIcon = Modules.Assets.mainAssetBundle.LoadAsset<Sprite>("texSpecialIcon"),
                activationState = new EntityStates.SerializableEntityStateType(typeof(SkillStates.FirstAid)),
                activationStateMachineName = "Weapon",
                baseMaxStock = 1,
                baseRechargeInterval = 10f,
                beginSkillCooldownOnSkillEnd = false,
            ...
            Modules.Skills.AddSpecialSkills(bodyPrefab, healSkillDef);
            #endregion
        }
        ...
        public override void InitializeSkins()
        {
            ...
            SkinDef defaultSkin = Modules.Skins.CreateSkinDef(MEDIC_PREFIX + "DEFAULT_SKIN_NAME",
