...
namespace MedicMod.Modules.Achievements
{
    ...
    {
        public override string AchievementTokenPrefix => MedicPlugin.DEVELOPER_PREFIX + "_HENRY_BODY_MASTERY";
        ...
        public override string PrerequisiteUnlockableIdentifier => MedicPlugin.DEVELOPER_PREFIX + "_HENRY_BODY_UNLOCKABLE_REWARD_ID";
